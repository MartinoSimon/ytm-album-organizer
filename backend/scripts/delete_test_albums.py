...
def main():
    ...
    print("\n1) Open this URL and enter the code:")
    ...
    while time.time() < deadline:
        ...
        if "access_token" in data:
            ...
            if not refresh_token:
                print("\n⚠️ No refresh_token was returned.")
                print("This usually happens if you have authorized before. Revoke the app access and try again.")
                print("Google Account -> Security -> Third-party access -> Remove access.")
                # We'll still save what we got, but it will expire.
            payload = {
    ...
    raise SystemExit("\n❌ Timeout waiting for authorization (device_code expired).")
